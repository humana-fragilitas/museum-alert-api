...
import { IoTClient,
         ...
         DetachPolicyCommand,
         DeletePolicyCommand } from '@aws-sdk/client-iot';
...
describe('deleteThingLambda', () => {
  ...
  test('should successfully delete thing with certificates when user owns the thing', async () => {
    ...
    expect(iotMock.commandCalls(ListAttachedPoliciesCommand)).toHaveLength(2);
    expect(iotMock.commandCalls(DetachPolicyCommand)).toHaveLength(2);
    expect(iotMock.commandCalls(DeletePolicyCommand)).toHaveLength(2);
